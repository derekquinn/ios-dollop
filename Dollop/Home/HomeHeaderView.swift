...
extension HomeHeaderView {
    func style(){
        ...
        greeting.text = "Good afternoon, friend👨‍👨‍👧‍👦"
    ...
    func layout(){
        ...
        NSLayoutConstraint.activate([
            // avoiding isEnabled = true
            greeting.topAnchor.constraint(equalToSystemSpacingBelow: topAnchor, multiplier: 1),/// 1 x 8 = 8 (multiplier x8)
            greeting.leadingAnchor.constraint(equalToSystemSpacingAfter: leadingAnchor, multiplier: 1), /// equal spacing on top and bottom (8)
